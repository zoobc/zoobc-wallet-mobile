...
export class SwitcthemeService {
    ...
    this.themes = [
      {
         name: 'zoobc',
         styles: [
          { themeVariable: '--ion-color-primary', value: '#2d3e76'},
          { themeVariable: '--ion-color-primary-rgb', value: '45,62,118'},
          { themeVariable: '--ion-color-primary-contrast', value: '#ffffff'},
          { themeVariable: '--ion-color-primary-contrast-rgb', value: '255,255,255'},
          { themeVariable: '--ion-color-primary-shade', value: '#283768'},
          { themeVariable: '--ion-color-primary-tint', value: '#425184'},
          { themeVariable: '--ion-item-ios-background-color', value: '#2d3e76'},
          { themeVariable: '--ion-item-md-background-color', value: '#2d3e76'},
          { themeVariable: '--ion-tabbar-background-color', value: '#2d3e76'},
          { themeVariable: '--ion-tabbar-ios-text-color-active', value: '#000000'},
          { themeVariable: '--ion-tabbar-md-text-color-active', value: '#000000'},
          { themeVariable: '--ion-background-color', value: '#153a81'}
        ]
      },
      {
        name: 'day',
        styles: [
          ...
          { themeVariable: '--ion-tabbar-ios-text-color-active', value: '#000000'},
          { themeVariable: '--ion-tabbar-md-text-color-active', value: '#000000'},
          { themeVariable: '--ion-background-color', value: '#f2f2f2'}
        ]
      },
      {
        name: 'night',
        styles: [
          ...
          { themeVariable: '--ion-background-color', value: '#1f2024'}
        ]
      }
    ]
